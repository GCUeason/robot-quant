...
- 逐日成熟样本门控：**未通过**；最近成熟样本50条，Brier=0.2504，AUC=0.6282；最近成熟窗口未同时通过Brier<0.25与AUC>0.5
- 不可执行影子目标仓位：**0%**。
...
|---|---:|---:|---:|---|
| 5日收益 | -0.77% | -12.43% | 11.77% | 范围内 |
| 20日收益 | 0.51% | -24.36% | 25.38% | 范围内 |
| 60日收益 | -14.95% | -29.40% | 41.48% | 范围内 |
| 距20日均线 | -3.91% | -14.68% | 12.91% | 范围内 |
| 距60日均线 | -9.52% | -20.75% | 21.68% | 范围内 |
| 20日年化波动 | 43.64% | 11.93% | 82.45% | 范围内 |
| 成交量/20日均量 | 0.78倍 | 0.53倍 | 1.76倍 | 范围内 |
| 20日相对强弱 | 0.05% | -12.13% | 15.94% | 范围内 |
| 沪深300距120日均线 | -2.62% | -20.51% | 17.68% | 范围内 |
...
| 20日 | 32 | 未通过历史验证 | 预测未同时击败零收益MAE基线并达到高于50%的方向准确率，收益预测已停用 |
...
| 最新尾窗 | 2026-06-05 | 2026-08-14 | 50 | 0.2507 | 0.6568 | 失败 |
...
|---|---:|---:|---:|---:|---:|
| 质量门控定投 | ¥16,000.00 | ¥15,724.31 | ¥-275.69 | -1.72% | -12.23% |
| 固定定投 | ¥16,000.00 | ¥15,724.31 | ¥-275.69 | -1.72% | -12.23% |
| 质量门控影子策略（不可执行） | ¥16,000.00 | ¥15,621.20 | ¥-378.80 | -2.37% | -2.82% |

质量门控定投相对固定定投的市值差：**¥0.00**

影子Alpha（影子策略相对固定定投的市值差）：**¥-103.11**。样本仅**30**个交易日，门控通过15日、实际持仓15日，当前只用于检验规则是否可能创造避险或超额收益。

![累计市值对比](performance.png)

## 数据口径与来源

- 模型特征与收益验证：`cnindex_official_980022`，覆盖2015-01-05至2026-08-28，共2833条。
