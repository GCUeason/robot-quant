...
- 逻辑回归原始分数：**47.96%**
- 向50%收缩25%后，未来10个交易日跑赢沪深300的预测概率型分数：**49.49%**
- 模型原始研究仓位：**0%**（不可执行）
...
- 模型研究概率：**49.49%**；批准概率固定为**50.00%**，表示当前没有可执行优势。
...
|---|---:|---:|---:|---|
| 5日收益 | 2.92% | -12.41% | 11.89% | 范围内 |
| 20日收益 | -0.61% | -24.38% | 25.37% | 范围内 |
| 60日收益 | -20.77% | -29.34% | 41.42% | 范围内 |
| 距20日均线 | 0.26% | -15.05% | 12.90% | 范围内 |
| 距60日均线 | -4.71% | -20.62% | 21.56% | 范围内 |
| 20日年化波动 | 21.28% | 11.95% | 82.39% | 范围内 |
| 成交量/20日均量 | 0.76倍 | 0.53倍 | 1.76倍 | 范围内 |
| 20日相对强弱 | 0.99% | -12.50% | 15.92% | 范围内 |
| 沪深300距120日均线 | -4.44% | -20.33% | 17.67% | 范围内 |
...
| 20日 | 40 | 样本达标 | -0.20% | -11.28% ～ 9.39% | 50.00% |
...
| 最新尾窗 | 2026-07-02 | 2026-09-09 | 50 | 0.2555 | 0.7996 | 失败 |
...
|---|---:|---:|---:|---:|---:|
| 质量门控定投 | ¥17,000.00 | ¥16,527.04 | ¥-472.96 | -2.78% | -14.55% |
| 固定定投 | ¥17,000.00 | ¥16,527.04 | ¥-472.96 | -2.78% | -14.55% |
| 质量门控影子策略（不可执行） | ¥17,000.00 | ¥16,582.50 | ¥-417.50 | -2.46% | -2.82% |

质量门控定投相对固定定投的市值差：**¥0.00**

影子Alpha（影子策略相对固定定投的市值差）：**¥55.46**。样本仅**48**个交易日，门控通过15日、实际持仓15日，当前只用于检验规则是否可能创造避险或超额收益。

![累计市值对比](performance.png)

## 数据口径与来源

- 模型特征与收益验证：`cnindex_official_980022`，覆盖2015-01-05至2026-09-23，共2851条。
