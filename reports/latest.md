...
- 逐日成熟样本门控：**未通过**；最近成熟样本50条，Brier=0.2555，AUC=0.7831；最近成熟窗口未同时通过Brier<0.25与AUC>0.5
- 不可执行影子目标仓位：**0%**。
...
|---|---:|---:|---:|---|
| 5日收益 | 3.33% | -12.41% | 11.89% | 范围内 |
| 20日收益 | -1.91% | -24.38% | 25.37% | 范围内 |
| 60日收益 | -12.57% | -29.34% | 41.42% | 范围内 |
| 距20日均线 | 0.15% | -15.05% | 12.90% | 范围内 |
| 距60日均线 | -5.76% | -20.62% | 21.56% | 范围内 |
| 20日年化波动 | 25.57% | 11.95% | 82.39% | 范围内 |
| 成交量/20日均量 | 1.01倍 | 0.53倍 | 1.76倍 | 范围内 |
| 20日相对强弱 | 0.50% | -12.50% | 15.92% | 范围内 |
| 沪深300距120日均线 | -4.63% | -20.33% | 17.67% | 范围内 |
...
| 最新尾窗 | 2026-06-29 | 2026-09-04 | 50 | 0.2553 | 0.8088 | 失败 |
...
|---|---:|---:|---:|---:|---:|
| 质量门控定投 | ¥17,000.00 | ¥16,501.84 | ¥-498.16 | -2.93% | -14.55% |
| 固定定投 | ¥17,000.00 | ¥16,501.84 | ¥-498.16 | -2.93% | -14.55% |
| 质量门控影子策略（不可执行） | ¥17,000.00 | ¥16,582.50 | ¥-417.50 | -2.46% | -2.82% |

质量门控定投相对固定定投的市值差：**¥0.00**

影子Alpha（影子策略相对固定定投的市值差）：**¥80.66**。样本仅**45**个交易日，门控通过15日、实际持仓15日，当前只用于检验规则是否可能创造避险或超额收益。

![累计市值对比](performance.png)

## 数据口径与来源

- 模型特征与收益验证：`cnindex_official_980022`，覆盖2015-01-05至2026-09-18，共2848条。
