...
- 逐日成熟样本门控：**通过**；最近成熟样本50条，Brier=0.2479，AUC=0.5705；最近成熟窗口通过，仅允许不可执行影子卫星仓
- 不可执行影子目标仓位：**20%**。
...
|---|---:|---:|---:|---|
| 5日收益 | -10.09% | -12.43% | 11.77% | 范围内 |
| 20日收益 | -0.39% | -24.36% | 25.38% | 范围内 |
| 60日收益 | -16.43% | -29.40% | 41.48% | 范围内 |
| 距20日均线 | -5.44% | -14.68% | 12.91% | 范围内 |
| 距60日均线 | -12.42% | -20.75% | 21.68% | 范围内 |
| 20日年化波动 | 49.09% | 11.93% | 82.45% | 范围内 |
| 成交量/20日均量 | 0.67倍 | 0.53倍 | 1.76倍 | 范围内 |
| 20日相对强弱 | 2.57% | -12.13% | 15.94% | 范围内 |
| 沪深300距120日均线 | -3.63% | -20.51% | 17.68% | 范围内 |
...
|---|---:|---|---:|---:|---:|
| 5日 | 40 | 样本达标 | 0.44% | -5.48% ～ 6.69% | 47.50% |
...
| 最新尾窗 | 2026-06-01 | 2026-08-10 | 50 | 0.2486 | 0.5760 | 通过 |
...
|---|---:|---:|---:|---:|---:|
| 质量门控定投 | ¥16,000.00 | ¥15,736.21 | ¥-263.79 | -1.65% | -12.23% |
| 固定定投 | ¥16,000.00 | ¥15,736.21 | ¥-263.79 | -1.65% | -12.23% |
| 质量门控影子策略（不可执行） | ¥16,000.00 | ¥15,628.77 | ¥-371.23 | -2.32% | -2.82% |

质量门控定投相对固定定投的市值差：**¥0.00**

影子Alpha（影子策略相对固定定投的市值差）：**¥-107.44**。样本仅**27**个交易日，门控通过13日、实际持仓12日，当前只用于检验规则是否可能创造避险或超额收益。

![累计市值对比](performance.png)

## 数据口径与来源

- 模型特征与收益验证：`cnindex_official_980022`，覆盖2015-01-05至2026-08-24，共2829条。
